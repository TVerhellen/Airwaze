...
namespace AirWaze.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        private readonly IUserStore<AirWazeUser> _userStore;
        ...
        private AirWazeUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<AirWazeUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(AirWazeUser)}'. " +
                    $"Ensure that '{nameof(AirWazeUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the external login page in /Areas/Identity/Pages/Account/ExternalLogin.cshtml");
            }
        }

        private IUserEmailStore<AirWazeUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<AirWazeUser>)_userStore;
        }
    }
}
